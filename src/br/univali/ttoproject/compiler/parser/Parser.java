...
public class Parser implements ParserConstants {
    ...
    public ArrayList<Instruction<Integer, Object>> program = new ArrayList<Instruction<Integer, Object>>();
  ...
  final public void VariableBlock() throws ParseException {
    try {
      ...
      default:
        ...
        if (token.kind != EOF)
            errorMessages += "Unexpected token '" + token.image + "' at line " + token.beginLine + ", column " + token.beginColumn + ". "
                           + "Expected variable or constant declaration.\u005cn";
    }
  }
  ...
  final public void ValueIdentifierList() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
      Index();
      ValueIdentifierList1();
      break;
    case CHAR_CONST:
    case NATURAL_CONST:
    case REAL_CONST:
  ...
  final public void ValueIdentifierList1() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
      jj_consume_token(COMMA);
      ValueIdentifierList();
  ...
  final public void Value() throws ParseException {
    try {
      ...
      default:
        ...
        if (token.kind != EOF)
            errorMessages += "Unexpected token '" + token.image + "' at line " + token.beginLine + ", column " + token.beginColumn + ". "
                           + "Expected a constant value (char, natural, real or boolean).\u005cn";
    }
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x0,0x400,0x1800,0x1000,0x800,0x3c000,0x0,0x3c000,0x0,0x0,0x0,0x0,0x2000,0x2000,0x3e80000,0x3e80000,0x0,0x0,0x0,0x0,0x800,0x40000000,0x0,0x3c000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x8,0x3f00000,0x8,0x1800000,0x0,0x0,0x0,0x0,0x1f800,0x40030,0x20780,0x40,0x3f00001,0x0,0x1f00000,0x0,};
   }
